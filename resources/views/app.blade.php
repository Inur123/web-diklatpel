...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="/images/favicon.webp?v=3" type="image/webp">
        <link rel="apple-touch-icon" href="/images/pwa-192x192.webp?v=2">
...
<link rel="apple-touch-startup-image" href="/images/splash/apple-splash-1136-640.webp" media="(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)">
        ...
        <x-inertia::head>
            <title>{{ config('app.name', 'DIKLATPEL 2026') }}</title>
        </x-inertia::head>
    </head>
