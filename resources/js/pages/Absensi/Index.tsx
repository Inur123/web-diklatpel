                    ...
                    <div className="w-full sm:w-auto">
                        ...
                        >
                            ...
                            <DialogTrigger asChild>
                                <Button
                                    size="icon"
                                    className="fixed right-4 bottom-[calc(5.75rem+env(safe-area-inset-bottom))] z-30 size-14 rounded-full bg-[#f97316] text-white shadow-[0_10px_28px_rgba(249,115,22,0.3)] hover:bg-[#ea580c] md:hidden"
