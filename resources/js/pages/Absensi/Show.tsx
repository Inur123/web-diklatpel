                                            ...
                                            <div className="min-w-0 flex-1">
                                                <div className="flex items-start justify-between gap-2">
                                                    ...
                                                    <span
                                                        className={
                                                            isPresent
                                                                ? 'inline-flex items-center gap-1 rounded-full border border-orange-200 bg-orange-50 px-2 py-1 text-[11px] font-semibold text-orange-700'
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell className="px-6 py-4">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <span className="font-medium text-gray-900 transition-colors group-hover:text-orange-700">
                                                                    {att
                                                                        .registration
                                                                        ?.name ||
                                                                        '-'}
