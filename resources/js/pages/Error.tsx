...
export default function ErrorPage({ status }: ErrorProps) {
    ...
    const description =
        ...
        'Permintaan Anda belum dapat diproses. Silakan coba kembali.';
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center bg-slate-50 p-6 text-center font-['Manrope',ui-sans-serif,system-ui,sans-serif] text-slate-900">
            ...
            <div className="mb-6 text-[4.5rem] leading-none font-extrabold tracking-tight text-[#f97316] sm:text-[6rem]">
                {status}
            </div>
            ...
            <Link
                ...
                className="inline-flex items-center justify-center rounded-lg bg-[#f97316] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#c2410c] focus:ring-2 focus:ring-[#f97316] focus:ring-offset-2 focus:outline-none"
            >
                {requiresLogin
