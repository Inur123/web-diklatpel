...
const STATUS_BADGE: Record<string, string> = {
    ...
    lolos: 'bg-orange-50 text-orange-700 border border-orange-200',
            ...
            <div className="flex w-full flex-col gap-6 p-4 md:p-6">
                <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
                    ...
                    <div className="hidden items-center gap-2.5 md:flex">
                        ...
                        <Button
                            ...
                            className="w-full justify-center border-orange-200 bg-orange-50/80 font-medium text-orange-700 hover:bg-orange-100 hover:text-orange-800 sm:w-auto"
                        >
                            {isDownloadingAllQr ? (
                    ...
                    {statistics.map((statistic) => (
                        ...
                        >
                            <CardHeader className="flex flex-row items-start justify-between gap-1 space-y-0 px-3 pb-0 sm:px-4">
                                ...
                                <statistic.icon className="text-muted-foreground size-3.5 shrink-0 sm:size-4" />
                            </CardHeader>
                                ...
                                {filteredData.map((registrant) => {
                                    ...
                                    return (
                                        <Link
                                            ...
                                            className="bg-card text-card-foreground block rounded-xl border p-4 shadow-sm transition-all hover:border-orange-200 hover:shadow-md active:scale-[0.98]"
                                        >
                ...
                <div className="fixed right-4 bottom-[calc(5.75rem+env(safe-area-inset-bottom))] z-30 flex flex-col gap-3 md:hidden">
                    ...
                    <Button
                        ...
                        onClick={handleDownloadAllQr}
                        disabled={isDownloadingAllQr}
                        className="size-12 rounded-full bg-[#f97316] text-white shadow-[0_8px_24px_rgba(249,115,22,0.28)] hover:bg-[#ea580c]"
