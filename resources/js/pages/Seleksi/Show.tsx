...
const STATUS_BADGE: Record<string, string> = {
    ...
    lolos: 'border-orange-200 bg-orange-50 text-orange-700',
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-0.5 text-xs text-gray-400">
                                Detail pendaftaran peserta DIKLATPEL CBP–KPP
                            </p>
                        </div>
                    </div>
                                        ...
                                        <div>
                                            ...
                                            {registrant.whatsapp ? (
                                                <a
                                                    ...
                                                    className="flex w-fit cursor-pointer items-center gap-1 font-semibold text-orange-600 hover:text-orange-800 hover:underline"
                                                >
                                                    {registrant.whatsapp}
                                            ...
                                            >
                                                ...
                                                {fileObj ? (
                                                    <a
                                                        ...
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="inline-flex cursor-pointer items-center gap-1 rounded-md border border-orange-200 bg-orange-50 px-2 py-1 text-[10px] font-bold text-orange-700 transition-colors hover:text-orange-900 hover:underline"
                                                    >
                                                        Buka{' '}
                                    ...
                                    <Dialog>
                                        <DialogTrigger asChild>
                                            <Button
                                                ...
                                                className="flex-1 bg-[#ea580c] text-xs font-bold text-white hover:bg-[#c2410c]"
                                            >
                                ...
                                <CardContent className="flex flex-col items-center justify-center space-y-4 py-5">
                                    ...
                                    <div className="w-full pt-1">
                                        <Button
                                            ...
                                            variant="default"
                                            className="h-10 w-full rounded-xl bg-[#f97316] font-semibold text-white shadow-sm hover:bg-[#ea580c]"
                                        >
                                            {isDownloading ? (
