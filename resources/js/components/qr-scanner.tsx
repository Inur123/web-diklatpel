        ...
        <div className="relative flex h-full min-h-[380px] w-full items-center justify-center overflow-hidden rounded-2xl border-2 border-gray-200 bg-zinc-900 shadow-sm select-none md:min-h-[460px] md:rounded-3xl">
            ...
            <div className="pointer-events-none absolute inset-x-5 top-16 bottom-5 z-10 flex flex-col justify-between md:inset-x-8 md:top-20 md:bottom-8">
                <div className="flex items-start justify-between">
                    <div className="h-7 w-7 rounded-tl-xl border-t-2 border-l-2 border-orange-400 sm:h-8 sm:w-8"></div>
                    <div className="h-7 w-7 rounded-tr-xl border-t-2 border-r-2 border-orange-400 sm:h-8 sm:w-8"></div>
                </div>
                <div className="flex items-end justify-between">
                    <div className="h-7 w-7 rounded-bl-xl border-b-2 border-l-2 border-orange-400 sm:h-8 sm:w-8"></div>
                    <div className="h-7 w-7 rounded-br-xl border-r-2 border-b-2 border-orange-400 sm:h-8 sm:w-8"></div>
                </div>
            </div>
                    ...
                    <Button
                        ...
                        className={`flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-medium backdrop-blur-md transition-all active:scale-95 ${
                            !canSwitch
                                ...
                                : isSwitching
                                  ? 'animate-pulse border-orange-400 bg-orange-600/60 text-white'
                                  : 'border-white/15 bg-black/50 text-white shadow hover:bg-black/70'
                        }`}
                    >
                        <SwitchCamera
                            className={`h-3.5 w-3.5 text-orange-400 ${isSwitching ? 'animate-spin' : ''}`}
                        />
            ...
            {error && (
                <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-zinc-950/95 p-6 text-center backdrop-blur-md">
                    ...
                    <Button
                        ...
                        className="flex items-center gap-2 rounded-xl bg-orange-600 px-4 py-2 text-xs font-semibold text-white shadow transition-all hover:bg-orange-500 active:scale-95"
                    >
