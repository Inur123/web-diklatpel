...
export function MobileBottomNavigation() {
        ...
        return (
            <Link
                ...
                className={cn(
                    ...
                    active ? 'text-[#ea580c]' : 'text-[#60758f]',
                    positionClass,
                )}
    ...
    return (
        <nav
            className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-5 bg-white/95 px-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] shadow-[0_-10px_34px_rgba(249,115,22,0.12)] backdrop-blur-xl md:hidden"
        ...
        >
            ...
            <Link
                href="/absensi"
                prefetch
                className="group col-start-3 flex min-w-0 flex-col items-center justify-end pb-1.5 text-[10px] font-semibold text-[#ea580c]"
                aria-current={absensiActive ? 'page' : undefined}
            >
                <span
                    className={cn(
                        '-mt-7 flex size-14 items-center justify-center rounded-full bg-[#f97316] text-white shadow-[0_10px_28px_rgba(249,115,22,0.34)] transition-transform active:scale-95',
            ...
            <Link
                ...
                className={cn(
                    ...
                    profileActive ? 'text-[#ea580c]' : 'text-[#60758f]',
                )}
