...
export function AppSidebarHeader({
    ...
    return (
        <header className="border-sidebar-border/50 sticky top-0 z-30 flex h-14 shrink-0 items-center border-b bg-gradient-to-r from-[#fff7ed]/95 via-white/95 to-[#fffaf5]/95 px-4 backdrop-blur-xl md:static md:h-16 md:bg-transparent md:bg-none md:px-4 md:backdrop-blur-none md:group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
