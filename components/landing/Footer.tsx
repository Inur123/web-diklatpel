...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0c0c0c] border-t border-[#262626] px-6 pt-16 pb-8 text-white sm:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          {/* Kolom 1: Brand / Deskripsi */}
          <div>
            <div className="mb-4 flex flex-col leading-tight">
              <span className="text-sm font-black tracking-wider text-[#f97316]">
                DIKLATPEL 2026
              </span>
              <span className="text-[9px] font-bold text-white/50 tracking-wider mt-0.5">
                PC IPNU IPPNU KABUPATEN MAGETAN
              </span>
            </div>
            <p className="text-[11px] leading-relaxed text-white/60 mb-6 font-medium">
              Pendidikan Dan Latihan Pelatih Corp Brigade Pembangunan - Korp
              Pelajar Putri Kabupaten Magetan. Mencetak pelatih &amp; instruktur
            ...
            <div className="space-y-2 text-[10px] text-white/60">
              ...
              <div className="flex items-center gap-2">
                <Mail className="h-3.5 w-3.5 text-[#f97316] shrink-0" />
                <a
                ...
                return (
                  <li key={`${link.href}-${i}`}>
                    <span
                      ...
                      className="text-white/70 transition-colors hover:text-[#f97316] cursor-pointer select-none"
                    >
                      {link.label}
                    </span>
                  </li>
              ...
              {CONTACT_INFO.phone.map((cp, idx) => (
                <li key={idx}>
                  ...
                  >
                    ...
                    <span className="hover:text-[#f97316]">
                      {cp.name} ({cp.number})
                    </span>
                  </a>
                </li>
        ...
        <div className="my-10 h-px bg-neutral-800" aria-hidden="true" />
