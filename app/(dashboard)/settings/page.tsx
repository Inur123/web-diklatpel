    ...
    <div className="p-6 space-y-6 max-w-xl">
      ...
      <div>
        <h1 className="text-xl font-bold text-gray-900 leading-tight flex items-center gap-2">
          <Settings className="h-5 w-5 text-[#f97316]" /> Pengaturan Portal
        </h1>
        <p className="text-xs text-gray-400 mt-1">
          Atur status aktif formulir pendaftaran DIKLATPEL Magetan 2026.
        </p>
      </div>
      ...
      <div className="rounded-xl !border !border-neutral-200 bg-white p-6 shadow-sm space-y-6">
        ...
        <div
          className={`flex items-center gap-2 rounded-lg px-4 py-3 text-xs font-semibold !border !border-neutral-200 ${
            isOpen
