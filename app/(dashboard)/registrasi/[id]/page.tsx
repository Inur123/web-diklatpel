    ...
    <div className="p-6 space-y-6 max-w-6xl">
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-2xl !border !border-neutral-200 bg-white text-neutral-600 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.05)] hover:bg-[#f97316]/5 hover:border-[#f97316] hover:text-[#f97316] cursor-pointer transition-all hover:scale-105 active:scale-95 shrink-0"
          aria-label="Kembali"
        >
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            Detail pendaftaran peserta DIKLATPEL
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="rounded-xl !border !border-neutral-200 bg-white p-6 shadow-sm space-y-4">
            <h3 className="font-bold text-gray-400 uppercase tracking-wider text-[9px] !border-b !border-neutral-200 pb-1">
              Data Diri &amp; Profil
            </h3>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              {(() => {
                ...
                const fotoUrl =
                  fotoObj?.r2_url ||
                  (fotoObj?.r2_key ? `/api/files/${fotoObj.r2_key}` : null);

                return (
                  <div className="flex flex-col items-center shrink-0">
                    {fotoUrl ? (
                      <div className="relative group overflow-hidden rounded-xl !border !border-neutral-200 bg-gray-50 h-36 w-28 shadow-sm">
                        <img
                          src={fotoUrl}
              ...
              <div className="flex-1 space-y-4">
                  ...
                  <div>
                    ...
                    <span className="font-semibold text-gray-800">
                      {registrant.birth_date ? (
                        new Date(registrant.birth_date).toLocaleDateString(
                          "id-ID",
                          {
                            day: "2-digit",
                            month: "long",
                  ...
                  <div>
                    ...
                    {registrant.whatsapp ? (
                      <a
                        ...
                        className="font-bold !text-emerald-600 hover:!text-emerald-700 hover:underline inline-flex items-center gap-1 w-fit cursor-pointer"
                      >
                        {registrant.whatsapp}
                ...
                <div className="pt-2 text-xs">
                  ...
                  <p className="text-gray-700 !bg-neutral-100/70 rounded-lg p-3 leading-relaxed font-medium">
                    {registrant.reason}
                  </p>
                </div>
              </div>
          ...
          <div className="rounded-xl !border !border-neutral-200 bg-white p-6 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              {Object.entries(FILE_FIELD_LABELS).map(([fieldKey, label]) => {
                ...
                const r2DownloadUrl =
                  fileObj?.r2_url ||
                  (fileObj?.r2_key ? `/api/files/${fileObj.r2_key}` : "#");

                return (
                  <div
                    key={fieldKey}
                    className="flex items-center justify-between !border !border-neutral-200 rounded-lg p-3 !bg-neutral-55"
                  >
                    ...
                    {fileObj ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1 text-[10px] font-bold !text-[#f97316] hover:!text-[#ea580c] hover:underline cursor-pointer border border-[#f97316]/20 bg-[#f97316]/5 rounded-md px-2.5 py-1 transition-colors"
                      >
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl !border !border-neutral-200 bg-white p-6 shadow-sm space-y-4">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="flex justify-between items-center py-1 !border-t !border-neutral-200 pt-2">
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent size="sm">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Apakah Anda yakin ingin meloloskan seleksi administrasi
                        untuk peserta <strong>{registrant.name}</strong>?
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction
                        onClick={() => handleUpdate("admin", "lolos")}
                        className="bg-emerald-700 hover:bg-emerald-800 text-white border-0 cursor-pointer"
                      >
                        Ya, Loloskan
                      </AlertDialogAction>
                    </AlertDialogFooter>
                ...
                <AlertDialog>
                  <AlertDialogTrigger
                    render={
                      <button
                        disabled={
                          registrant.admin_status === "ditolak" ||
                          updating !== null
                        }
                  ...
                  <AlertDialogContent size="sm">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Apakah Anda yakin ingin menolak berkas administrasi
                        peserta <strong>{registrant.name}</strong>?
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      <AlertDialogCancel className="cursor-pointer">
                      ...
                      <AlertDialogAction
                        onClick={() => handleUpdate("admin", "ditolak")}
            ...
            <div className="space-y-2.5 !border-t !border-neutral-200 pt-4">
                  ...
                  <AlertDialogContent size="sm">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        <strong>{registrant.name}</strong> lolos tahap
                        wawancara/screening?
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction
                        onClick={() => handleUpdate("screening", "lolos")}
                        className="bg-emerald-700 hover:bg-emerald-800 text-white border-0 cursor-pointer"
                      >
                        Ya, Loloskan
                      </AlertDialogAction>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent size="sm">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Apakah Anda yakin ingin menolak peserta{" "}
                        <strong>{registrant.name}</strong> pada tahap screening?
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      <AlertDialogCancel className="cursor-pointer">
                      ...
                      <AlertDialogAction
                        onClick={() => handleUpdate("screening", "ditolak")}
                        className="bg-red-600 hover:bg-red-700 text-white border-0 cursor-pointer"
                      >
                        Ya, Tolak
                      </AlertDialogAction>
              ...
              {registrant.admin_status !== "lolos" && (
                <p className="text-[9px] text-red-500 font-medium leading-relaxed mt-1">
                  * Screening hanya aktif jika status Administrasi peserta
                  Lolos.
                </p>
              )}
            </div>
