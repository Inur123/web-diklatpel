  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl animate-pulse">
      ...
      <div className="flex items-center gap-4">
        ...
        <Skeleton className="h-9 w-9 rounded-lg shrink-0 !border !border-neutral-200" />
          ...
          <div className="rounded-xl !border !border-neutral-200 bg-white p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="flex items-center justify-between !border !border-neutral-200 rounded-lg p-3">
