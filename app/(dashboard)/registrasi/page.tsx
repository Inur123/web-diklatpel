  ...
  const handleExportExcel = () => {
    ...
    try {
      ...
      import("xlsx-js-style").then((xlsx) => {
        ...
        xlsx.writeFile(
          workbook,
          `Data_Seleksi_Diklatpel_${new Date().getFullYear()}.xlsx`,
        );
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">
            DIKLATPEL DKC CBP KPP Kabupaten Magetan 2026
          </p>
        </div>
        <div className="grid grid-cols-2 gap-2 w-full sm:flex sm:items-center sm:w-auto">
          <button
            onClick={handleExportExcel}
            className="inline-flex w-full sm:w-auto items-center justify-center gap-1.5 rounded-lg border border-[#f97316] bg-[#f97316] px-3 py-1.5 text-xs font-bold text-white hover:bg-[#ea580c] transition-colors shadow-sm cursor-pointer"
          >
          ...
          <button
            onClick={fetchData}
            disabled={loading}
            className="inline-flex w-full sm:w-auto items-center justify-center gap-1.5 rounded-lg !border !border-neutral-200 bg-white px-3 py-1.5 text-xs font-semibold text-neutral-600 hover:bg-[#f97316]/5 hover:border-[#f97316] hover:text-[#f97316] transition-all shadow-sm cursor-pointer disabled:opacity-50"
          >
      ...
      <div className="grid grid-cols-3 gap-3 md:grid-cols-6">
        <div className="rounded-xl !border !border-neutral-200 bg-white p-4 shadow-sm relative overflow-hidden">
      ...
      {/* Tab Navigation */}
      <div className="flex rounded-lg !bg-neutral-100 p-0.5 w-fit">
        <button
              ...
              <tbody className="!divide-y !divide-neutral-200">
                {filteredData.map((reg, idx) => {
                  ...
                  return (
                    <tr
                      key={reg.id}
                      className="hover:!bg-neutral-55 transition-colors"
                    >
                      ...
                      <td className="px-4 py-3 text-center">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-lg !border !border-neutral-200 bg-white px-3 py-1.5 text-xs font-semibold text-neutral-600 hover:bg-[#f97316]/5 hover:border-[#f97316] hover:text-[#f97316] transition-all shadow-sm cursor-pointer"
                        >
