  ...
  return (
    <div className="flex flex-col gap-6 p-6 w-full">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-gray-400 font-semibold mt-0.5">
            Selamat datang di Admin Portal DIKLATPEL DKC CBP KPP MAGETAN Magetan
            2026.
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="!border-gray-200 shadow-sm rounded-2xl hover:shadow-md transition-all">
          ...
          <CardContent>
            ...
            <p className="text-[10px] font-bold text-[#f97316] flex items-center gap-1 mt-1">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        {/* Recent Registrants */}
        <Card className="col-span-4 !border-gray-200 shadow-sm rounded-2xl">
          <CardHeader>
        ...
        <Card className="col-span-3 !border-gray-200 shadow-sm rounded-2xl flex flex-col justify-between">
          <div>
            <CardHeader>
              <CardTitle className="text-sm font-black text-gray-800">
                Aksi Cepat Admin
            ...
            <CardContent className="space-y-2">
              <Link href="/registrasi" className="block w-full">
                <Button
                  variant="secondary"
                  className="w-full justify-start rounded-xl font-bold text-xs !bg-neutral-100 !border !border-neutral-300 !text-neutral-700 hover:!bg-[#f97316]/10 hover:!border-[#f97316] hover:!text-[#f97316] transition-all cursor-pointer h-10 px-4"
                >
                  <ClipboardList className="mr-2 h-4 w-4 text-[#f97316]" />
              ...
              <Link href="/settings" className="block w-full">
                <Button
                  ...
                  className="w-full justify-start rounded-xl font-bold text-xs !bg-neutral-100 !border !border-neutral-300 !text-neutral-700 hover:!bg-[#f97316]/10 hover:!border-[#f97316] hover:!text-[#f97316] transition-all cursor-pointer h-10 px-4"
                >
                  <Settings className="mr-2 h-4 w-4 text-[#f97316]" />
          ...
          <div className="p-6 pt-0">
            <div className="bg-neutral-50 rounded-xl p-3 border border-neutral-200 text-[10px] text-neutral-600 font-bold leading-relaxed">
